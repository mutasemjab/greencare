# AI Development Rules for GreenCare
...
**Directory structure for GreenCare:**
...
**Main file:** `resources/views/admin/products/index.blade.php`
...
<div class="container-fluid">
    {{-- Page Header --}}
    @include('admin.products.partials.header')
...
**Partial:** `resources/views/admin/products/partials/header.blade.php`
...
-   **ALWAYS add** translations to both `resources/lang/ar/messages.php` and `resources/lang/en/messages.php`
...
**Translation files for GreenCare:**
...
-   **ALWAYS use** proper file editing tools (Edit, Write)
...
```php
// ✅ CORRECT - Use Edit or Write tools
