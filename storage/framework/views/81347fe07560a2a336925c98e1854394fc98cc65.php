...
$(document).ready(function() {
   ...
   $('.doctors-select').select2({
    ...
    ajax: {
        ...
        processResults: function (data, params) {  // ✅ Fixed - same as patients
            return {
    ...
    $('.report-templates-select').select2({
        ...
        ajax: {
           ...
           processResults: function (data, params) {
            return {
                results: data.data.map(function(template) {  // ✅ Correct - accessing data.data
                    return {
                        id: template.id,
                ...
                pagination: {
                    more: data.current_page < data.last_page  // ✅ Correct - pagination support
                }
            };
        }
        },
