<?php $__env->startSection('title', __('messages.add_new_appointment')); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    ...
                    <?php echo e(__('messages.add_new_appointment')); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('showers.store')); ?>" method="POST" id="showerForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($room->code); ?>" 
                                                ...
                                                <?php echo e(old('code_patient') == $room->code ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('date_of_shower', date('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('time_of_shower')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                           value="<?php echo e(old('price', $defaultPrice)); ?>"
                                           step="0.01"
                                           min="0">
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $availableCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($card->id); ?>" 
                                                ...
                                                <?php echo e(old('card_number_id') == $card->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                          placeholder="<?php echo e(__('messages.add_notes')); ?>"><?php echo e(old('note')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i><?php echo e(__('messages.save_appointment')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    codePatientSelect.addEventListener('change', function() {
        ...
        if (discount > 0 && paymentCash.checked) {
            ...
            const message = `<?php echo e(__('messages.discount_will_be_applied', ['percent' => '__PERCENT__', 'amount' => '__AMOUNT__', 'final' => '__FINAL__'])); ?>`;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\greencare\resources\views/admin/showers/create.blade.php ENDPATH**/ ?>