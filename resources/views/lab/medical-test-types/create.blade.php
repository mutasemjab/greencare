...
@section('title', 'إضافة نوع فحص طبي')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">إضافة نوع فحص طبي</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('lab.type-medical-tests.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                           ...
                                           value="{{ old('name') }}" placeholder="أدخل اسم الفحص" required>
                                    @error('name')
