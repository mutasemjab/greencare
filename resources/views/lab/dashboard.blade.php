        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <a href="{{ route('lab.appointments.index', ['type' => 'medical_test']) }}" class="btn btn-outline-primary">
                        <i class="bi bi-list-ul"></i> جميع مواعيد الفحوصات
                    </a>
                    <a href="{{ route('lab.appointments.index', ['type' => 'medical_test', 'status' => 'pending']) }}" class="btn btn-outline-warning">
                        <i class="bi bi-clock"></i> المواعيد المعلقة
                    </a>
                    <a href="{{ route('lab.appointments.index', ['type' => 'medical_test', 'status' => 'processing']) }}" class="btn btn-outline-info">
                        <i class="bi bi-gear"></i> قيد المعالجة
                    </a>
                    <a href="{{ route('lab.type-medical-tests.index') }}" class="btn btn-outline-secondary">
                        <i class="bi bi-flask"></i> إدارة أنواع الفحوصات
                    </a>
                </div>
            </div>
        </div>
...
{{-- آخر مواعيد الفحوصات الطبية --}}
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">آخر مواعيد الفحوصات الطبية</h5>
                <a href="{{ route('lab.appointments.index', ['type' => 'medical_test']) }}" class="btn btn-sm btn-primary">عرض الكل</a>
            </div>
            <div class="card-body">
                @if($recentMedicalTests->isEmpty())
