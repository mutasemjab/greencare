        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.edit_patient') }}: {{ $user->name }}</h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="gender" 
                                        ...
                                        <option value="1" {{ old('gender', $user->gender) == '1' ? 'selected' : '' }}>{{ __('messages.male') }}</option>
                                        <option value="2" {{ old('gender', $user->gender) == '2' ? 'selected' : '' }}>{{ __('messages.female') }}</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-sm table-borderless">
                                            <tr>
                                                ...
                                                <td><span class="badge bg-info">{{ $user->user_type_text }}</span></td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> {{ __('messages.update_patient') }}
                                </button>
                            </div>
                        </div>
                    </div>
