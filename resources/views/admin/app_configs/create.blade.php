                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('google_play_link_user_app') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('app_store_link_user_app') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('hawawi_link_user_app') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('min_version_google_play_user_app') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('min_version_app_store_user_app') }}"
                                                   placeholder="{{ __('messages.enter_version') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('min_version_hawawi_user_app') }}"
                                                   placeholder="{{ __('messages.enter_version') }}">
