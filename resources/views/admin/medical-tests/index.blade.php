...
@section('title', __('messages.medical_test_types'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('messages.medical_test_types') }}</h3>
                    <a href="{{ route('medical-tests.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <form method="GET" action="{{ route('medical-tests.index') }}" class="d-flex">
                                <input type="text" 
                                       name="search" 
                        ...
                        <div class="col-md-8">
                            <form method="GET" action="{{ route('medical-tests.index') }}" class="d-flex">
                                ...
                                <a href="{{ route('medical-tests.index') }}" class="btn btn-outline-secondary">{{ __('messages.clear') }}</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('medical-tests.destroy', $test) }}" 
                                                      method="POST" 
                                                      style="display: inline;"
                                                      onsubmit="return confirm('{{ __('messages.confirm_delete_test') }}')">
                                                    @csrf
                                                    @method('DELETE')
