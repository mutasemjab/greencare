                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_of_visit') is-invalid @enderror" 
                                ...
                                <option value="home" {{ old('type_of_visit', $providerCategory->type_of_visit) == 'home' ? 'selected' : '' }}>
                                    {{ __('messages.home') }}
                                </option>
                                <option value="hospital" {{ old('type_of_visit', $providerCategory->type_of_visit) == 'hospital' ? 'selected' : '' }}>
                                    {{ __('messages.hospital') }}
                                </option>
                                <option value="clinic" {{ old('type_of_visit', $providerCategory->type_of_visit) == 'clinic' ? 'selected' : '' }}>
                                    {{ __('messages.clinic') }}
                                </option>
                            </select>
                            @error('type_of_visit')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                ...
                                id="price" 
                                name="price" 
                                value="{{ old('price', $providerCategory->price) }}" 
                                required>
                            @error('price')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                ...
                                value="{{ old('phone_of_emeregency', $providerCategory->phone_of_emeregency) }}" 
                                required>
