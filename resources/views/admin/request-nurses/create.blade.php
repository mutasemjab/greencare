...
@section('title', __('messages.add_request-nurses_type'))
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('messages.add_request-nurses_type') }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('request-nurses.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="type_of_service" 
                                        ...
                                        @foreach(\App\Models\TypeRequestNurse::getServiceTypes() as $key => $value)
                                            <option value="{{ $key }}" {{ old('type_of_service') == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
