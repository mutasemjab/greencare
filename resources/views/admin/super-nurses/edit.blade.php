        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.edit_nurse') }}: {{ $superNurse->name }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('super-nurses.index') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> {{ __('messages.back') }}
                        </a>
                    </div>
                </div>

                <form action="{{ route('super-nurses.update', $superNurse) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('name', $superNurse->name) }}" 
                                           placeholder="{{ __('messages.enter_nurse_name') }}" 
                                           required>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('phone', $superNurse->phone) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" 
                                           ...
                                           value="{{ old('email', $superNurse->email) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('date_of_birth', $superNurse->date_of_birth->format('Y-m-d')) }}" 
                                           required>
                                    @error('date_of_birth')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="gender" 
                                        ...
                                        <option value="1" {{ old('gender', $superNurse->gender) == '1' ? 'selected' : '' }}>{{ __('messages.male') }}</option>
                                        <option value="2" {{ old('gender', $superNurse->gender) == '2' ? 'selected' : '' }}>{{ __('messages.female') }}</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="activate" 
                                        ...
                                        <option value="1" {{ old('activate', $superNurse->activate) == '1' ? 'selected' : '' }}>{{ __('messages.active') }}</option>
                                        <option value="2" {{ old('activate', $superNurse->activate) == '2' ? 'selected' : '' }}>{{ __('messages.inactive') }}</option>
                                    </select>
                                    @error('activate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <!-- nurse Information Summary -->
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title">{{ __('messages.current_information') }}</h6>
                                        <table class="table table-sm table-borderless">
                                            <tr>
                                                <td><strong>{{ __('messages.nurse_type') }}:</strong></td>
                                                <td><span class="badge bg-info">{{ $superNurse->nurse_type_text }}</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            @if($superNurse->families->count() > 0)
                                                <tr>
                                                    <td><strong>{{ __('messages.families') }}:</strong></td>
                                                    <td>
                                                        @foreach($superNurse->families as $family)
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                @can('nurse-table')
                                    <a href="{{ route('super-nurses.show', $superNurse) }}" class="btn btn-info me-2">
                                        <i class="fas fa-eye"></i> {{ __('messages.view_details') }}
                                    </a>
                                @endcan
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> {{ __('messages.update_nurse') }}
                                </button>
                            </div>
                        </div>
                    </div>
