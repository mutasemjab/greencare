...
@section('title', __('messages.add_provider'))

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('messages.add_provider') }}</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('messages.add_provider') }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('providers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('number_years_experience') }}" 
                                   required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('provider_category_id') is-invalid @enderror" 
                                ...
                                <option value="{{ $category->id }}" {{ old('provider_category_id') == $category->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    <label for="photo">{{ __('messages.provider_photo') }} <span class="text-danger">*</span></label>
                    <input type="file" 
