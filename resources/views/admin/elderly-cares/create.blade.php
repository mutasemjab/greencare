...
@section('title', __('messages.add_elderly_care_type'))
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('messages.add_elderly_care_type') }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('elderly-cares.store') }}" method="POST">
                        @csrf
