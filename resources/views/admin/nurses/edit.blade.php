        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.edit_nurse') }}: {{ $nurse->name }}</h3>
                ...
                <form action="{{ route('nurses.update', $nurse) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('date_of_birth', $nurse->date_of_birth->format('Y-m-d')) }}" 
                                           required>
                                    @error('date_of_birth')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="gender" 
                                        ...
                                        <option value="1" {{ old('gender', $nurse->gender) == '1' ? 'selected' : '' }}>{{ __('messages.male') }}</option>
                                        <option value="2" {{ old('gender', $nurse->gender) == '2' ? 'selected' : '' }}>{{ __('messages.female') }}</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="activate" 
                                        ...
                                        <option value="1" {{ old('activate', $nurse->activate) == '1' ? 'selected' : '' }}>{{ __('messages.active') }}</option>
                                        <option value="2" {{ old('activate', $nurse->activate) == '2' ? 'selected' : '' }}>{{ __('messages.inactive') }}</option>
                                    </select>
                                    @error('activate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-sm table-borderless">
                                            <tr>
                                                ...
                                                <td><span class="badge bg-info">{{ $nurse->nurse_type_text }}</span></td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                @can('nurse-table')
                                    <a href="{{ route('nurses.show', $nurse) }}" class="btn btn-info me-2">
